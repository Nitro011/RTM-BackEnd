...
namespace RTM.Persistence.Migrations
{
    ...
    [Migration("20200817062945_AgregarOrdenesClientesEstilosYOrdenesClientesSizes")]
    partial class AgregarOrdenesClientesEstilosYOrdenesClientesSizes
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RTM.Models.TableDB.OrdenesClientes_Estilos", b =>
                {
                    b.Property<int>("OrdenesCliente_EstiloID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("OrdenesCliente_EstiloID");

                    b.HasIndex("EstiloID");

                    b.HasIndex("Orden_ClienteID");

                    b.ToTable("OrdenesClientes_Estilos");
                });

            modelBuilder.Entity("RTM.Models.TableDB.OrdenesClientes_Sizes", b =>
                {
                    b.Property<int>("OrdenesCliente_SizeID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("OrdenesCliente_SizeID");

                    b.HasIndex("Orden_ClienteID");

                    b.HasIndex("SizeID");

                    b.ToTable("OrdenesClientes_Sizes");
                });
            ...
            modelBuilder.Entity("RTM.Models.TableDB.OrdenesClientes_Estilos", b =>
                {
                    ...
                    b.HasOne("RTM.Models.Ordenes_Clientes", "Ordenes_Clientes")
                        .WithMany("OrdenesClientes_Estilos")
                        .HasForeignKey("Orden_ClienteID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("RTM.Models.TableDB.OrdenesClientes_Sizes", b =>
                {
                    b.HasOne("RTM.Models.Ordenes_Clientes", "Ordenes_Clientes")
                        .WithMany("OrdenesClientes_Sizes")
                        .HasForeignKey("Orden_ClienteID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RTM.Models.Size", "Sizes")
                        .WithMany()
                        .HasForeignKey("SizeID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
